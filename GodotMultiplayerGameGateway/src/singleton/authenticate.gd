...
@rpc("reliable")
func create_account_result(result: bool, player_id: int, message: int) -> void:
	print("Create account results received: ", result, " Message: ", message)
	Gateway.return_create_new_account_request(result, player_id, message)
	pass
